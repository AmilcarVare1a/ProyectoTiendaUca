    ...
    do {
        ...
        switch(opcion) {
            ...
            case 3: {
                ...
                int pos = buscarVideojuego(juegos, total, codigo);

                if(pos == -1) {
                    cout << "\nVideojuego no encontrado." << endl;
                } else {
                    cout << "\n=== VIDEOJUEGO ENCONTRADO ===";
                    cout << "\nCodigo: " << juegos[pos].codigo;
                    cout << "\nNombre: " << juegos[pos].nombre;
                    cout << "\nPrecio: $" << juegos[pos].precio;
                    cout << "\nCantidad: " << juegos[pos].cantidad << endl;
                }
...
void registrarVenta(Videojuego juegos[], int total) {
    ...
    if(cantidad > juegos[pos].cantidad) {
        cout << "\nNo hay suficientes unidades disponibles." << endl;
    } else {
        juegos[pos].cantidad -= cantidad;
